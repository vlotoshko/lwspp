...
install(EXPORT lwsppClientTargets
    NAMESPACE lwspp::
    DESTINATION ${CMAKE_CONFIG_DESTINATION}
)

install(TARGETS ${TARGET_LWSPP_CLIENT_STATIC} ${TARGET_LWSPP_CLIENT_SHARED}
    EXPORT lwsppClientTargets
